...
public class T_MainPage extends Presets {
    ...
    /*@FindBy(xpath = "//li//a//span[text()='Проектирование']")
     div#content div > li > ul > li:nth-child(4) > a > span
    public WebElement Sample_Engineering;
    @Step ("Нажать на раздел Проектирование")
    ...
    @FindBy(css = "div#content div._2mNsXe2wYFTOP3 > div > div > div > div > span > span")
    WebElement SearchIcon;

    @Step ("Ввести название шаблона в поиск")
    ...
    @Step ("Нажать кнопку поиска шаблона")
